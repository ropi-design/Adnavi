        ...
        <div class="mb-8">
            <nav class="flex gap-4 border-b" style="border-color: #374151;">
                <a href="/settings/profile"
                    class="pb-4 px-2 font-semibold transition-colors border-b-2 {{ request()->routeIs('profile.edit') ? 'text-blue-500 border-blue-500' : 'text-gray-400 border-transparent hover:text-gray-300' }}"
                    style="{{ request()->routeIs('profile.edit') ? 'color: #3b82f6; border-color: #3b82f6;' : 'color: #9ca3af; border-color: transparent;' }}">
                    プロフィール
                </a>
                <a href="/settings/password"
                    class="pb-4 px-2 font-semibold transition-colors border-b-2 {{ request()->routeIs('user-password.edit') ? 'text-blue-500 border-blue-500' : 'text-gray-400 border-transparent hover:text-gray-300' }}"
                    style="{{ request()->routeIs('user-password.edit') ? 'color: #3b82f6; border-color: #3b82f6;' : 'color: #9ca3af; border-color: transparent;' }}">
                    パスワード
                </a>
                <a href="/settings/appearance"
                    class="pb-4 px-2 font-semibold transition-colors border-b-2 {{ request()->routeIs('appearance.edit') ? 'text-blue-500 border-blue-500' : 'text-gray-400 border-transparent hover:text-gray-300' }}"
                    style="{{ request()->routeIs('appearance.edit') ? 'color: #3b82f6; border-color: #3b82f6;' : 'color: #9ca3af; border-color: transparent;' }}">
                    表示
                </a>
            </nav>
        </div>
