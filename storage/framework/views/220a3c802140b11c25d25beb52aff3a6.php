...
<div class="min-h-screen bg-black p-4 lg:p-8" x-data="{
                    ...
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($dateRange): ?>
                            <p class="text-xs text-gray-500 mt-1">
                                期間: <?php echo e($dateRange['start']->format('Y年m月d日')); ?> ～
    ...
    <div class="mb-6 bg-zinc-900 p-4 rounded-xl shadow-sm border border-zinc-700">
        <div class="flex gap-2 mb-3">
            <button wire:click="changePeriod('today')" type="button"
                class="flex-1 px-4 py-2.5 rounded-lg text-sm font-medium whitespace-nowrap <?php echo e($selectedPeriod === 'today' ? 'text-white' : 'text-gray-300 hover:bg-zinc-800'); ?>"
                style="<?php echo e($selectedPeriod === 'today' ? 'background-color: #4285F4;' : ''); ?>">
                今日
            </button>
            <button wire:click="changePeriod('week')" type="button"
                class="flex-1 px-4 py-2.5 rounded-lg text-sm font-medium whitespace-nowrap <?php echo e($selectedPeriod === 'week' ? 'text-white' : 'text-gray-300 hover:bg-zinc-800'); ?>"
                style="<?php echo e($selectedPeriod === 'week' ? 'background-color: #4285F4;' : ''); ?>">
                今週
            </button>
            <button wire:click="changePeriod('month')" type="button"
                class="flex-1 px-4 py-2.5 rounded-lg text-sm font-medium whitespace-nowrap <?php echo e($selectedPeriod === 'month' ? 'text-white' : 'text-gray-300 hover:bg-zinc-800'); ?>"
                style="<?php echo e($selectedPeriod === 'month' ? 'background-color: #4285F4;' : ''); ?>">
                今月
            </button>
            <button wire:click="$set('showCustomDatePicker', true)" type="button"
                class="flex-1 px-4 py-2.5 rounded-lg text-sm font-medium whitespace-nowrap <?php echo e($selectedPeriod === 'custom' ? 'text-white' : 'text-gray-300 hover:bg-zinc-800'); ?>"
                style="<?php echo e($selectedPeriod === 'custom' ? 'background-color: #4285F4;' : ''); ?>">
                カスタム期間
            </button>
        </div>

        <!--[if BLOCK]><![endif]--><?php if($showCustomDatePicker || $selectedPeriod === 'custom'): ?>
            <div class="mt-4 pt-4 border-t border-zinc-700 flex gap-3 items-end" x-data="{
                    ...
                    setTimeout(() => {
                        ...
                        if (startInput && !startInput._flatpickr) {
                            flatpickr(startInput, {
                                ...
                                onChange: function(selectedDates, dateStr) {
                                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('customStartDate', dateStr);
                        ...
                        if (endInput && !endInput._flatpickr) {
                            flatpickr(endInput, {
                                ...
                                onChange: function(selectedDates, dateStr) {
                                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('customEndDate', dateStr);
                                }
                            });
                        }
                    }, 100);
                ...
                <div class="flex flex-col gap-2">
                    <button wire:click="setCustomDate" wire:loading.attr="disabled"
                        <?php if(!$customStartDate || !$customEndDate): ?> disabled <?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($metrics && !$loading): ?>
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mb-2">
                            <?php echo e(number_format($metrics['clicks']['value'])); ?>
                        ...
                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 rounded-md">
                            ...
                            <span
                                class="text-sm font-semibold text-green-700">+<?php echo e(number_format($metrics['clicks']['change'], 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-zinc-900 rounded-xl shadow-sm border border-zinc-700 p-6 hover:shadow-md transition-shadow cursor-pointer"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mb-2">
                            <?php echo e(number_format($metrics['conversions']['value'])); ?>
                        ...
                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 rounded-md">
                            ...
                            <span
                                class="text-sm font-semibold text-green-700">+<?php echo e(number_format($metrics['conversions']['change'], 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-zinc-900 rounded-xl shadow-sm border border-zinc-700 p-6 hover:shadow-md transition-shadow cursor-pointer"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mb-2">
                            ¥<?php echo e(number_format($metrics['cost']['value'])); ?>
                        ...
                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 rounded-md">
                            ...
                            <span
                                class="text-sm font-semibold text-green-700"><?php echo e(number_format($metrics['cost']['change'], 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-zinc-900 rounded-xl shadow-sm border border-zinc-700 p-6 hover:shadow-md transition-shadow cursor-pointer"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mb-2">
                            <?php echo e(number_format($metrics['ctr']['value'], 2)); ?>%
                        </p>
                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 rounded-md">
                            <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <span
                                class="text-sm font-semibold text-green-700">+<?php echo e(number_format($metrics['ctr']['change'], 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-zinc-900 rounded-xl shadow-sm border border-zinc-700 p-6 hover:shadow-md transition-shadow cursor-pointer"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mb-2">
                            <?php echo e(number_format($metrics['cvr']['value'], 2)); ?>%
                        </p>
                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 rounded-md">
                            <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                            ...
                            <span
                                class="text-sm font-semibold text-green-700">+<?php echo e(number_format($metrics['cvr']['change'], 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-zinc-900 rounded-xl shadow-sm border border-zinc-700 p-6 hover:shadow-md transition-shadow cursor-pointer"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mb-2">
                            <?php echo e(number_format($metrics['impressions']['value'])); ?>
                        ...
                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 rounded-md">
                            ...
                            <span
                                class="text-sm font-semibold text-green-700">+<?php echo e(number_format($metrics['impressions']['change'], 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-zinc-900 rounded-xl shadow-sm border border-zinc-700 p-6 hover:shadow-md transition-shadow cursor-pointer"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mb-2">
                            ¥<?php echo e(number_format($metrics['cpc']['value'], 2)); ?>
                        ...
                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 rounded-md">
                            ...
                            <span
                                class="text-sm font-semibold text-green-700"><?php echo e(number_format($metrics['cpc']['change'], 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-zinc-900 rounded-xl shadow-sm border border-zinc-700 p-6 hover:shadow-md transition-shadow cursor-pointer"
                ...
                <div class="flex items-start justify-between mb-4">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mb-2">
                            ¥<?php echo e(number_format($metrics['cpa']['value'])); ?>
                        ...
                        <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-50 rounded-md">
                            ...
                            <span
                                class="text-sm font-semibold text-green-700"><?php echo e(number_format($metrics['cpa']['change'], 1)); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showGraphModal && $dailyData): ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH /var/www/html/resources/views/livewire/dashboard/overview.blade.php ENDPATH**/ ?>