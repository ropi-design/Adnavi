...
<div class="space-y-6 p-6 lg:p-8">
    ...
    <!--[if BLOCK]><![endif]--><?php if($analyticsProperties->count() > 0): ?>
        <div class="space-y-4">
                ...
                <div class="card p-6 hover:shadow-xl transition-all duration-300">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <h3 class="font-bold text-xl mb-1" style="color: #ffffff;"><?php echo e($property->property_name); ?>

                            </h3>
                            <p class="text-sm text-gray-500 font-mono mb-3">ID: <?php echo e($property->property_id); ?></p>

                            <div class="flex flex-wrap items-center gap-4 text-sm bg-gray-50 rounded-lg p-3">
                                <div>
                                    <span class="text-gray-600">タイムゾーン:</span>
                                    <span class="font-bold text-gray-900 ml-2"><?php echo e($property->timezone); ?></span>
                                </div>
                                <!--[if BLOCK]><![endif]--><?php if($property->last_synced_at): ?>
                                    <div>
                                        <span class="text-gray-600">最終同期:</span>
                                        <span
                                            class="font-semibold text-blue-600 ml-2"><?php echo e($property->last_synced_at->diffForHumans()); ?></span>
                                    </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                        </div>
                        <a href="/accounts/analytics/<?php echo e($property->id); ?>"
                            class="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-colors border-2"
                            style="background-color: #ffffff; color: #000000; border-color: #e5e7eb;">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH /var/www/html/resources/views/livewire/accounts/analytics-property-list.blade.php ENDPATH**/ ?>