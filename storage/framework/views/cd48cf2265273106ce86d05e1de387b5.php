...
<div class="space-y-6 p-6 lg:p-8">
    ...
    <!--[if BLOCK]><![endif]--><?php if($adAccounts->count() > 0): ?>
                    ...
                    <div class="space-y-4">
                                ...
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <h3 class="font-bold text-lg truncate" style="color: #ffffff;">
                                            <?php echo e($account->account_name); ?></h3>
                                        <p class="text-sm font-mono" style="color: #9ca3af;">ID:
                                            <?php echo e($account->customer_id); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3 rounded-lg p-4" style="background-color: #ffffff;">
                            <div class="flex items-center justify-between text-sm">
                                ...
                                <span class="font-bold text-gray-900"><?php echo e($account->currency); ?></span>
                            </div>
                            <div class="flex items-center justify-between text-sm">
                                <span class="text-gray-600 flex items-center gap-2">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="font-bold text-gray-900"><?php echo e($account->timezone); ?></span>
                            </div>
                            <!--[if BLOCK]><![endif]--><?php if($account->last_synced_at): ?>
                                <div class="flex items-center justify-between text-sm">
                                    <span class="text-gray-600 flex items-center gap-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <span
                                        class="font-semibold text-blue-600"><?php echo e($account->last_synced_at->diffForHumans()); ?></span>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                        </div>
                        ...
                        <div class="flex gap-2 pt-2 border-t border-gray-200">
                            <button wire:click="checkSync(<?php echo e($account->id); ?>)"
                                class="w-full px-4 py-2.5 rounded-lg hover:bg-gray-50 transition-colors font-medium text-sm flex items-center justify-center gap-2"
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH /var/www/html/resources/views/livewire/accounts/ad-account-list.blade.php ENDPATH**/ ?>