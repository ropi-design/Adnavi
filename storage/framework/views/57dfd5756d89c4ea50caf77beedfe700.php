...
new class extends Component implements Livewire\Volt\Contracts\FunctionalComponent
{
    ...
    public function loadInsight($id)
    {
        $arguments = [static::$__context, $this, func_get_args()];

        return (new Actions\CallMethod('loadInsight'))->execute(...$arguments);
    }
    ...
    public function implementRecommendation($recommendationId)
    {
        ...
        return (new Actions\CallMethod('implementRecommendation'))->execute(...$arguments);
    }
